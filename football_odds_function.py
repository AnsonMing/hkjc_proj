...
class http_req_results():
    ...
    def get_results(self):  # find/input data
        self.find_matches()
        tmp_count = 0
        tmp_total_count = 0
    ...
    def gen_csv(self, csv_name):
        ...
        with open(csv_name, 'w', newline='',encoding='utf-8') as csvfile:
            ...
            writer.writerow(['officialID','MatchID','homeTeam_CH', 'homeTeam_EN', 'awayTeam_CH', 'awayTeam_EN', 'froutEndid', 'tShortCH', 'tShortEN', 'date', 'hadodds', 'sgaodds',
                            'fhaodds', 'hhaodds', 'hdcodds', 'hilodds', 'fhlodds', 'chlodds', 'crsodds', 'fcsodds', 'ftsodds', 'ttgodds', 'ooeodds', 'hftodds'])
            # Write data to CSV file
            for i in self.get_results():
                writer.writerow([i['officialID'],i['MatchID'],i['homeTeam_CH'], i['homeTeam_EN'], i['awayTeam_CH'], i['awayTeam_EN'], i['froutEndid'], i['tShortCH'], i['tShortEN'], i['date'], i['hadodds'], i['sgaodds'],
                                i['fhaodds'], i['hhaodds'], i['hdcodds'], i['hilodds'], i['fhlodds'], i['chlodds'], i['crsodds'], i['fcsodds'], i['ftsodds'], i['ttgodds'], i['ooeodds'], i['hftodds']])
...
if __name__ == '__main__':
    http_req_results().gen_csv('odds.csv')
